...
public class WeChatReservationController extends BaseController {
    ...
    /**
     * 预约班次管理，当使用人选中班次，且点击确定按钮时,shiftsId,dateTime,shiftsStatus
     */
    @PreAuthorize("@ss.hasPermi('WeChat:reservation:AddReservation')")
    @Log(title = "预约班次管理", businessType = BusinessType.INSERT)
    @PostMapping
    public AjaxResult AddReservation(@RequestBody WeChatReservation weChatReservation) {
...
//
     ...
     * 取消预约
     */
    @PreAuthorize("@ss.hasPermi('WeChat:reservation:cancel')")
