    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['biz:enterprise:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['biz:enterprise:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleImport"
          v-hasPermi="['biz:enterprise:import']"
          >导入</el-button
        >
      </el-col>
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['biz:enterprise:export']"
          >导出</el-button
        >
      </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/biz/enterprise/importData", // todo
      },
  ...
  methods: {
    ...
    /** 导入按钮操作 */
    handleImport() {
      this.upload.title = "企业基本信息导入"; // todo
      this.upload.open = true;
    },
    /** 下载模板操作 */
    importTemplate() {
      this.download(
        "biz/enterprise/importTemplate",
        {},
        `enterprise_base_template_${new Date().getTime()}.xlsx`
      ); // todo
    },
    // 文件上传中处理
