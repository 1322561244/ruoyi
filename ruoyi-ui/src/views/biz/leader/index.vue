    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属企业名称" prop="enterpriseName">
          ...
          <select id='model' v-model="data.EnterpriseName" style="width:100px">
            <option>型号</option>
...
<script>
import {listLeader, getLeader, delLeader, addLeader, updateLeader, enterpriseList} from "@/api/biz/leader";
import Treeselect from "@riophae/vue-treeselect";
import axios from "axios";
import {getEnterprise} from "@/api/biz/enterprise";
