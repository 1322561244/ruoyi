      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="车长名" prop="leaderId">
          <el-select v-model="form.leaderId" placeholder="请选择车长">
            <el-option v-for="iteam in leaderList" :label="iteam.leaderName" :value="iteam.leaderId"
                       :key="iteam.leaderId"/>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="司机名" prop="driversId">
          <el-select v-model="form.driversId" placeholder="请选择车长">
            <el-option v-for="iteam in driversList" :label="iteam.driversName" :value="iteam.driversId"
                       :key="iteam.driversId"/>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="车牌号" prop="vehiclesId">
          ...
          <el-select v-model="form.vehiclesId" placeholder="请选择车长">
            <el-option v-for="iteam in vehiclesList" :label="iteam.vehiclesLicensePlate" :value="iteam.vehiclesId"
...
<script>
import {addShifts, delShifts, getShifts, listShifts, updateShifts} from "@/api/biz/shifts";
