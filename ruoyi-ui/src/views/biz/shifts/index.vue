<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="车辆ID" prop="vehiclesId">
        <el-input
          v-model="queryParams.vehiclesId"
          placeholder="请输入车辆ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="shiftsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="车辆ID" align="center" prop="vehiclesId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="车辆ID" prop="vehiclesId">
          <el-input v-model="form.vehiclesId" placeholder="请输入车辆ID" />
        </el-form-item>
      </el-form>
