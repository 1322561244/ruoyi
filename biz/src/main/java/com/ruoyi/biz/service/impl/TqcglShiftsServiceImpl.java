...
import com.ruoyi.biz.domain.TqcglShifts2;
...
public class TqcglShiftsServiceImpl implements ITqcglShiftsService 
{
    ...
    @Override
    public List<TqcglShifts2> selectTqcglShiftsList2(TqcglShifts tqcglShifts)
    {
        return tqcglShiftsMapper.selectTqcglShiftsList2(tqcglShifts);
    }
    /**
     * 新增班次管理
     * 
