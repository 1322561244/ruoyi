  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="车长姓名" prop="leaderId">
        ...
        <el-form-item label="司机姓名" prop="driversId">
        ...
        <el-form-item label="车牌号码" prop="vehiclesId">
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/biz/shifts/importData", // todo
      },
  ...
  methods: {
    ...
    /** 导入按钮操作 */
    handleImport() {
      this.upload.title = "班次基本信息导入"; // todo
      this.upload.open = true;
    },
    /** 下载模板操作 */
    importTemplate() {
      this.download(
        "biz/shifts/importTemplate",
        {},
        `shifts_base_template_${new Date().getTime()}.xlsx`
      ); // todo
    },
    // 文件上传中处理
